      ...
      >
        ...
        <IconButton
          ...
          sx={{
            ...
            opacity: isOverlayActive && isHoveredRef.current ? 1 : 0,
            transform: isOverlayActive && isHoveredRef.current ? "scale(1)" : "scale(0)",
            pointerEvents: isOverlayActive && isHoveredRef.current ? "auto" : "none",
