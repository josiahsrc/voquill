export const translations = {
	en: {
		...
		blogTitle: 'Blog',
		blogSubtitle: 'Guides, tips, and insights on voice typing and productivity.',
		...
		pricingPro: 'Pro',
		pricingProDesc: 'Full power with cloud transcription and advanced integrations.',
		...
		downloadPageTitle: 'Download Voquill',
		downloadPageHeading: 'Make voice your new keyboard.',
		downloadPageSubtitle: 'Dictate four times faster using your voice.',
	...
	es: {
		...
		blogTitle: 'Blog',
		blogSubtitle: 'Guías, consejos e información sobre dictado por voz y productividad.',
		...
		pricingPro: 'Pro',
		pricingProDesc: 'Potencia total con transcripción en la nube e integraciones avanzadas.',
		pricingPerMonth: '/ mes',
		...
		pricingEnterpriseDesc: 'Soluciones personalizadas para equipos con necesidades avanzadas.',
