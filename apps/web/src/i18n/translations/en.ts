...
export const enTranslations = {
  ...
  authorizePageTitle: "Authorize Voquill",
  authorizePageDescription:
    "Sign in to authorize access to your Voquill account.",
  authorizeTitleSignIn: "Sign in",
  authorizeTitleSignUp: "Sign up",
  authorizeTitleResetPassword: "Reset password",
  authorizeTitleEmailSent: "Email sent",
  authorizeContinueWithGoogle: "Continue with Google",
  authorizeOr: "or",
  authorizeEmail: "Email",
  authorizePassword: "Password",
  authorizeConfirmPassword: "Confirm password",
  authorizeShowPassword: "Show",
  authorizeHidePassword: "Hide",
  authorizeLogIn: "Log in",
  authorizeForgot: "Forgot?",
  authorizeCreateAccount: "Create account",
  authorizeHaveAccount: "Already have an account? Log in",
  authorizeResetDescription: "Enter your email and we'll send a reset link.",
  authorizeSendResetLink: "Send reset link",
  authorizeBack: "\u2190 Back",
  authorizeResetSentDescription:
    "An email has been sent to you with a link to reset your password.",
  authorizeTermsPrefix: "By using Voquill, you agree to our",
  authorizeTermsLink: "Terms & Conditions",
  authorizeAnd: "and",
  authorizePrivacyLink: "Privacy Policy",
  authorizeEnterValidEmail: "Enter a valid email address.",
  authorizePasswordMinLength: "Use at least 8 characters.",
  authorizePasswordsDoNotMatch: "Passwords do not match.",
  authorizeSigningIn: "Signing in\u2026",
  authorizeCreatingAccount: "Creating account\u2026",
  authorizeSending: "Sending\u2026",
  authorizeErrCliOnly: "This page must be opened by the Voquill CLI.",
  authorizeErrInvalidCredential: "Incorrect email or password.",
  authorizeErrEmailInUse: "An account already exists for that email.",
  authorizeErrWeakPassword: "Password must be at least 8 characters.",
  authorizeErrInvalidEmail: "That email address is not valid.",
  authorizeErrCancelled: "Sign-in was cancelled.",
  authorizeErrTooManyRequests: "Too many attempts. Try again in a minute.",
  authorizeErrNetwork: "Network error. Check your connection.",
