...
// Panel surface dimensions (matching AssistantModePanel.tsx).
// The panel surface INCLUDES the pill area at the bottom — the pill
// sits inside the panel, 8 px above the panel bottom edge.
...
// Top/bottom padding around the panel inside the window.
