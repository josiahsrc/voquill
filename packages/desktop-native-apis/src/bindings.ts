...
export type DictationFormat = "verbatim" | "clean"
export type DictationIntent = { kind: "dictation"; format: DictationFormat } | { kind: "command"; action?: string | null }
