...
- Workflow secrets required: `TAURI_PRIVATE_KEY`, `TAURI_PRIVATE_KEY_PASSWORD` (if used), `TAURI_UPDATER_PUBLIC_KEY`, `DESKTOP_VERSION_BUCKET`, `DESKTOP_BINARIES_BUCKET`, and `HUB_STORAGE_SERVICE_ACCOUNT_B64` (base64-encoded service account JSON with write access to both buckets).
